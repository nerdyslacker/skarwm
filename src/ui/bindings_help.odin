...
binding_description :: proc(b: ^input.Binding) -> string {
    ...
    case .Reminder_New:        return fmt.aprintf("set a countdown reminder")
    case .Reminder_Show_All:   return fmt.aprintf("show pending reminders")
    case .Reminder_Clear_All:  return fmt.aprintf("clear all reminders")
