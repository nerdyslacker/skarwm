...
// GENERATED by scripts/gen_keysyms.sh - do not edit by hand.
// One row per #define XK_<name> <value> from the X11 keysym header.
// Keysym names are ASCII identifiers, so no quoting is required.
XK_Entry :: struct { name: string, value: u32 }
keysym_names := [?]XK_Entry{
    {"VoidSymbol", 0xffffff},
    {"BackSpace", 0xff08},
    {"Tab", 0xff09},
    {"Linefeed", 0xff0a},
